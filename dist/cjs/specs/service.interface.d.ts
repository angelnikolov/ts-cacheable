...
export interface IService<T> {
    ...
    getDataWithCustomCacheResolver(parameter: string, _cacheRerouterParameter?: {
        straightToLastCache: boolean;
    }): T;
    getDataWithCustomCacheResolverAndHasher(parameter: number): T;
