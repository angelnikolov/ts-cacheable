...
describe('PCacheableDecorator', function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    parameters.forEach(function (param) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, (service.getDataWithMaxCacheCount(param), 1000)];
    ...
    it('should clear all caches when the global cache buster is called', function () { return __awaiter(_this, void 0, void 0, function () {
        var Service, service, asyncFreshData1, cachedResponse1, asyncFreshData2, cachedResponse2, asyncFreshData3, cachedResponse3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
